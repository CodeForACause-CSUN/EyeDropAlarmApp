import { StyleSheet, Button, Modal, TextInput, TouchableOpacity } from "react-native";
...
<View style={styles.container}>
    ...
    <Modal>
        ...
        <View style={styles.modalViewable}>
            ...
            <TouchableOpacity onPress={() => setIsNumDaysVisible(!isNumDaysVisible)}>
            <Text style={styles.rightAdjustedText}>{numDaysSelectedValue} days</Text>
            </TouchableOpacity>
            {isNumDaysVisible  && (
                <View>
                <Picker
                ...
                onValueChange={(itemValue) => setNumDaysSelectedValue(itemValue)}
                >
                {numbers.map((number) => (
                    <Picker.Item key={number} label={number.toString()} value={number} />
                ))}
                </Picker>
                <TouchableOpacity style={styles.doneButton}onPress={() => setIsNumDaysVisible(false)}>
                <Text>Done</Text>
                </TouchableOpacity>
                </View>
            )}
            ...
            <Text style={styles.rightAdjustedText}>{selectedValue} times a day</Text>
            </TouchableOpacity>
            {isPickerVisible  && (
                <View>
                <Picker
                ...
                <TouchableOpacity style={styles.doneButton}onPress={() => setIsPickerVisible(false)}>
                <Text>Done</Text>
                </TouchableOpacity>
                </View>
            )}
            ...
            <TouchableOpacity onPress={() => setIsTapperOneVisible(!isTapperOneVisible)}>
            <Text style={styles.rightAdjustedText}>{tapperOneSelectedValue} drops</Text>
            </TouchableOpacity>
            {isTapperOneVisible  && (
                <View>
                <Picker
                ...
                onValueChange={(itemValue) => setTapperOneSelectedValue(itemValue)}
                >
                {numbers.map((number) => (
                    <Picker.Item key={number} label={number.toString()} value={number} />
                ))}
                </Picker>
                <TouchableOpacity style={styles.doneButton}onPress={() => setIsTapperOneVisible(false)}>
                <Text>Done</Text>
                </TouchableOpacity>
                </View>
            )}

            <TouchableOpacity onPress={() => setIsTapperTwoVisible(!isTapperTwoVisible)}>
            <Text style={styles.rightAdjustedText}>every {tapperTwoSelectedValue} days</Text>
            </TouchableOpacity>
            {isTapperTwoVisible  && (
                <View>
                <Picker
                ...
                onValueChange={(itemValue) => setTapperTwoSelectedValue(itemValue)}
                >
                {numbers.map((number) => (
                    <Picker.Item key={number} label={number.toString()} value={number} />
                ))}
                </Picker>
                <TouchableOpacity style={styles.doneButton}onPress={() => setIsTapperTwoVisible(false)}>
                <Text>Done</Text>
                </TouchableOpacity>
                </View>
            )}
            ...
            <Button title="Save" onPress={printToConsole}/>
        </View>
        </View>
    </Modal>
</View>
